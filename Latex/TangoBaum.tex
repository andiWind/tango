...
\begin{enumerate}
	...
	\item Ist $w_a$ ein linkes bzw. rechtes Kind eines Knoten $v$ ?. Wenn ja setze die Wurzel von $G$ als linkes bzw. rechtes Kind von $v$	 
\end{enumerate}
...
\begin{enumerate}
	...
	\item Ist $w_1$ ein linkes bzw. rechtes Kind eines Knoten $v$ ?. Wenn ja setze die Wurzel von $H$ als linkes bzw. rechtes Kind von $v$	 
\end{enumerate}
