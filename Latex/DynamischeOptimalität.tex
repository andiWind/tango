...
Im letzten Abschnitt wurde gezeigt, dass für die Ausführung einer beliebigen Zugriffsfolge $X$, mit Länge $m$, für einen BST $T$ mit $n$ Knoten im worst case Kosten von  $O\left(m \log n\right)$ angenommen werden müssen. Stellt man zusätzliche Bedingungen an die Zugriffsfolgen, ist es in manchen Fällen jedoch möglich niedrigere Kosten zu verwenden. Hier werden fünf Eigenschaften zu BST vorgestellt die sich genau auf solche speziellere Zugriffssequenzen beziehen.
