...
Sei $p$ der Zeiger der \textit{access} Operation in $T$. Erreicht $p$ während des Suchens in einem Hilfsbaum $H_1$ die Wurzel eines weiteren Hilfsbaum $H_2$ werden die Knoten von $H_1$, entsprechend ihrer \textit{depth} Variable  mit einer \textit{cut} Operation in zwei Bäume  aufgeteilt.    
