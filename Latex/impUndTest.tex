...
Der Splay Baum startet genau wir der Tango Baum perfekt balanciert, auch wenn es sich bei längeren Zugriffsfolgen nur minimal auswirken sollte. Ansonsten gibt es keine Besonderheiten. \textit{access} Verhält sich genau wie im Kapitel zum Splay Baum beschrieben.
...
\paragraph{TangoTree}
\enquote{auxTree} macht die Wurzel des Tango Baum erreichbar. Außerdem können über diesen Attribut die \textit{split} und \textit{join} Operationen aufgerufen werden.

\paragraph{RedBlackTree und RBTNode}
Erweitern die abstrakten Klassen.
