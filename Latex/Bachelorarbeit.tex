...
\begin{enumerate}
	...
	\item $\mathit{bh} \left(T_{i} \right) =  \mathit{bh} \left(t_{v+1} \right) +1$ und beide Kinder der Wurzel von $T_i$ sind schwarz und $\mathit{bh} \left(v_{i} \right) = \mathit{bh} \left(v_{i+1} \right)$
\end{enumerate}
