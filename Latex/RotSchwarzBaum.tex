...
\begin{enumerate}
	...
	\item $\forall i \in \{1,2,..,m\}$. Ist der Schlüssel $k_i$ von $v_i$ kleiner als $k$ vereinige, $T_L$ mit dem aus $T$ herausgelösten linken Teilbaum von $v_i$, mit  $k_i$ als dritten Parameter. Ansonsten vereinige $T_R$ mit dem aus $T$ herausgelösten rechten Teilbaum von $v_i$, mit  $k_i$ als dritten Parameter. 
